...
public class NewsOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            NewsData.DataBean.NewsListBean[] kets = (NewsData.DataBean.NewsListBean[]) savedInstanceState.getParcelableArray("key");
            if (kets != null && kets.length != 0) {
                mData = new ArrayList<>();
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getActivity()).inflate(R.layout.newsitem, null, false);
